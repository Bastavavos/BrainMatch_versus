...
class SocketClient {
  ...
  void connect({
    ...
    required String categoryId,
    required String currentUser,
    required void Function(dynamic data) onStartGame,
    required void Function(dynamic data) onNewQuestion,
    required void Function(dynamic data) onAnswerFeedback,
    required void Function(dynamic data) onGameOver,
    void Function(String)? onError,
    bool isHost = false,
  }) {
    socket = IO.io(
      // Tu peux utiliser dotenv pour mettre l'URL si tu veux
      // dotenv.env['API_KEY'] ?? 'http://192.168.1.74:3000',
      'http://192.168.1.74:3000',
      IO.OptionBuilder()
          .setTransports(['websocket'])
          .enableAutoConnect()
