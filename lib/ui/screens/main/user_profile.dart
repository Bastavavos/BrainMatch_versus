...
class _UserProfilePageState extends ConsumerState<UserProfilePage> {
  ...
  Future<void> _fetchUserData() async {
    ...
    if (response.statusCode == 200) {
      ...
      // On stocke aussi dans le provider global
      ...
      setState(() {
        _error = "Erreur lors de la récupération des données utilisateur.";
        _isLoading = false;
      });
    }
  }

  Future<void> _fetchFriendsData(List<String> friendIds, String baseUrl, String? token) async {
  ...
  Widget build(BuildContext context) {
    ...
    if (_userData == null) {
      return const Scaffold(body: Center(child: Text("Aucune donnée utilisateur trouvée.")));
    }
