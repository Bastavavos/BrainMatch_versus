...
class CategoryConfirmationPage extends StatefulWidget {
  final String categoryId;
  final String title;
  final String description;
  final String imageUrl;
  ...
  @override
  State<CategoryConfirmationPage> createState() => _CategoryConfirmationPageState();
}

class _CategoryConfirmationPageState extends State<CategoryConfirmationPage> {
  @override
  Widget build(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
    final primaryColor = widget.mode == 'Solo' ? colorScheme.primary : colorScheme.secondary;
  ...
  void _handleStartPressed() {
    ...
    if (widget.mode == 'Solo') {
      ...
      // Mode Versus : Affiche boîte d’attente
      showDialog(
        context: context,
        barrierDismissible: false,
        builder: (_) => const AlertDialog(
